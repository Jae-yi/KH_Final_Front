  ...
  return (
    <Context>
      <div>
        ...
        <span className="title">개인정보 보호방침</span>
      </div>
      <div>
        <p>
          {"<"} Devs {">"}(이하 'Devs')은(는) 「개인정보 보호법」 제30조에 따라
          정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게
          처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을
          수립·공개합니다.
        </p>
        <p>○ 이 개인정보처리방침은 2022년 12월 26일부터 적용됩니다.</p>
        <br />
        <p>제1조(개인정보의 처리 목적)</p>
        <p>
          {"<"} Devs {">"}(이하 'Devs')은(는) 다음의 목적을 위하여 개인정보를
        ...
        <p>
          ① {"<"} Devs {">"}은(는) 법령에 따른 개인정보 보유·이용기간 또는
        ...
        <p>
          ① {"<"} Devs {">"}은(는) 다음의 개인정보 항목을 처리하고 있습니다.
        </p>
        <p>
          1{"<"} 홈페이지 회원가입 및 관리 {">"}
        </p>
        ...
        <p>
          ① {"<"} Devs {">"} 은(는) 개인정보 보유기간의 경과, 처리목적 달성 등
        ...
        <p>1. 파기절차</p>
        <p>
          {"<"} Devs {">"} 은(는) 파기 사유가 발생한 개인정보를 선정하고, {"<"}{" "}
          Devs {">"} 의 개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다.
        </p>
        <p>2. 파기방법</p>
        <p>
        ...
        <p>
          ① 정보주체는 DevS에 대해 언제든지 개인정보 열람·정정·삭제·처리정지
          요구 등의 권리를 행사할 수 있습니다.
        </p>
        <p>
          ② 제1항에 따른 권리 행사는 DevS에 대해 「개인정보 보호법」 시행령
          제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수
          있으며 DevS은(는) 이에 대해 지체 없이 조치하겠습니다.
        </p>
        <p>
        ...
        <p>
          ⑥ DevS은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구,
        ...
        <p>
          {" "}
          {"<"} Devs {">"}은(는) 개인정보의 안전성 확보를 위해 다음과 같은
          조치를 취하고 있습니다.
        </p>
        ...
        <p>
          Devs 은(는) 정보주체의 이용정보를 저장하고 수시로 불러오는
          ‘쿠키(cookie)’를 사용하지 않습니다.
        </p>
        <br />
        <p>제9조 (개인정보 보호책임자에 관한 사항)</p>
        <p>
          ① Devs 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보
        ...
        <p> 성명 : 조동주</p>
        <p> 직책 : 팀장</p>
        <p> 연락처 : 02-123-4567, Devs@gmail.com</p>
        ...
        <p>
          ② 정보주체께서는 Devs 의 서비스(또는 사업)을 이용하시면서 발생한 모든
          개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보
          보호책임자 및 담당부서로 문의하실 수 있습니다. Devs 은(는) 정보주체의
        ...
        <p>
          {"<"} Devs {">"}은(는) 정보주체의 개인정보 열람청구가 신속하게
          처리되도록 노력하겠습니다.
        </p>
